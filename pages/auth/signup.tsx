      ...
      <div className='bg-slate-800 border border-slate-400 rounded-md p-8 shadow-lg back backdrop-filter backdrop-blur-sm bg-opacity-30 relative text-orange-600'>
        ...
        <form onSubmit={handleSignUp}>
          ...
          <div className='relative my-6'>
            ...
            />
            {showPassword ? (
              <AiOutlineUnlock className='absolute top-4 right-4 cursor-pointer' onClick={togglePasswordVisibility}/>
            ) : (
              <AiOutlineLock className='absolute top-4 right-4 cursor-pointer' onClick={togglePasswordVisibility}/>
            )}
          </div>
          <div className='relative my-6'>
            <input
            ...
            />
            {showConfirmPassword ? (
              <AiOutlineUnlock className='absolute top-4 right-4 cursor-pointer' onClick={toggleConfirmPasswordVisibility}/>
            ) : (
              <AiOutlineLock className='absolute top-4 right-4 cursor-pointer' onClick={toggleConfirmPasswordVisibility}/>
            )}
          </div>
